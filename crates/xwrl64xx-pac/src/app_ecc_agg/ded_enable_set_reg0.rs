...
#[doc = "Field `RES13` reader - 31:14\\]
RESERVE FIELD"]
pub type Res13R = crate::FieldReader<u32>;
#[doc = "Field `RES13` writer - 31:14\\]
RESERVE FIELD"]
pub type Res13W<'a, REG> = crate::FieldWriter<'a, REG, 18, u32>;
impl R {
    #[doc = "Bit 0 - 0:0\\]
Interrupt Enable Set Register for app_ss_rom_pend - (RW )"]
    #[inline(always)]
...
RESERVE FIELD"]
    ...
    pub fn res13(&self) -> Res13R {
        Res13R::new((self.bits >> 14) & 0x0003_ffff)
    }
}
impl W {
    #[doc = "Bit 0 - 0:0\\]
Interrupt Enable Set Register for app_ss_rom_pend - (RW )"]
    #[inline(always)]
    #[must_use]
    pub fn app_ss_rom_enable_set(&mut self) -> AppSsRomEnableSetW<DedEnableSetReg0Spec> {
...
Interrupt Enable Set Register for app_ss_ram1_pend - (RW )"]
    #[inline(always)]
    #[must_use]
    pub fn app_ss_ram1_enable_set(&mut self) -> AppSsRam1EnableSetW<DedEnableSetReg0Spec> {
...
Interrupt Enable Set Register for app_ss_ram2_pend - (RW )"]
    #[inline(always)]
    #[must_use]
    pub fn app_ss_ram2_enable_set(&mut self) -> AppSsRam2EnableSetW<DedEnableSetReg0Spec> {
...
Interrupt Enable Set Register for app_ss_ram3_pend - (RW )"]
    #[inline(always)]
    #[must_use]
    pub fn app_ss_ram3_enable_set(&mut self) -> AppSsRam3EnableSetW<DedEnableSetReg0Spec> {
...
Interrupt Enable Set Register for app_ss_tptc1_pend - (RW )"]
    #[inline(always)]
    #[must_use]
    pub fn app_ss_tptc1_enable_set(&mut self) -> AppSsTptc1EnableSetW<DedEnableSetReg0Spec> {
...
Interrupt Enable Set Register for app_ss_tptc2_pend - (RW )"]
    #[inline(always)]
    #[must_use]
    pub fn app_ss_tptc2_enable_set(&mut self) -> AppSsTptc2EnableSetW<DedEnableSetReg0Spec> {
...
Interrupt Enable Set Register for hwa_tptc1_pend - (RW )"]
    #[inline(always)]
    #[must_use]
    pub fn hwa_tptc1_enable_set(&mut self) -> HwaTptc1EnableSetW<DedEnableSetReg0Spec> {
...
Interrupt Enable Set Register for hwa_tptc2_pend - (RW )"]
    #[inline(always)]
    #[must_use]
    pub fn hwa_tptc2_enable_set(&mut self) -> HwaTptc2EnableSetW<DedEnableSetReg0Spec> {
...
Interrupt Enable Set Register for shared_mem0_ramecc_pend - (RW )"]
    ...
    pub fn shared_mem0_ramecc_enable_set(
        &mut self,
    ) -> SharedMem0RameccEnableSetW<DedEnableSetReg0Spec> {
...
Interrupt Enable Set Register for shared_mem1_ramecc_pend - (RW )"]
    ...
    pub fn shared_mem1_ramecc_enable_set(
        &mut self,
    ) -> SharedMem1RameccEnableSetW<DedEnableSetReg0Spec> {
...
Interrupt Enable Set Register for hwa_param_mem_pend - (RW )"]
    #[inline(always)]
    #[must_use]
    pub fn hwa_param_mem_enable_set(&mut self) -> HwaParamMemEnableSetW<DedEnableSetReg0Spec> {
...
Interrupt Enable Set Register for shared_mem2_ramecc_pend - (RW )"]
    ...
    pub fn shared_mem2_ramecc_enable_set(
        &mut self,
    ) -> SharedMem2RameccEnableSetW<DedEnableSetReg0Spec> {
...
Interrupt Enable Set Register for adcping_ramecc_pend - (RW )"]
    #[inline(always)]
    #[must_use]
    pub fn adcping_ramecc_enable_set(&mut self) -> AdcpingRameccEnableSetW<DedEnableSetReg0Spec> {
...
Interrupt Enable Set Register for adcpong_ramecc_pend - (RW )"]
    #[inline(always)]
    #[must_use]
    pub fn adcpong_ramecc_enable_set(&mut self) -> AdcpongRameccEnableSetW<DedEnableSetReg0Spec> {
...
RESERVE FIELD"]
    #[inline(always)]
    #[must_use]
    pub fn res13(&mut self) -> Res13W<DedEnableSetReg0Spec> {
        Res13W::new(self, 14)
    }
}
