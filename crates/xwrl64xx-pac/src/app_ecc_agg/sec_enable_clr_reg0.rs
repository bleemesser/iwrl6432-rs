...
Interrupt Enable Clear Register for app_ss_rom_pend - (RW )"]
    #[inline(always)]
    #[must_use]
    pub fn app_ss_rom_enable_clr(&mut self) -> AppSsRomEnableClrW<SecEnableClrReg0Spec> {
...
Interrupt Enable Clear Register for app_ss_ram1_pend - (RW )"]
    #[inline(always)]
    #[must_use]
    pub fn app_ss_ram1_enable_clr(&mut self) -> AppSsRam1EnableClrW<SecEnableClrReg0Spec> {
...
Interrupt Enable Clear Register for app_ss_ram2_pend - (RW )"]
    #[inline(always)]
    #[must_use]
    pub fn app_ss_ram2_enable_clr(&mut self) -> AppSsRam2EnableClrW<SecEnableClrReg0Spec> {
...
Interrupt Enable Clear Register for app_ss_ram3_pend - (RW )"]
    #[inline(always)]
    #[must_use]
    pub fn app_ss_ram3_enable_clr(&mut self) -> AppSsRam3EnableClrW<SecEnableClrReg0Spec> {
...
Interrupt Enable Clear Register for app_ss_tptc1_pend - (RW )"]
    #[inline(always)]
    #[must_use]
    pub fn app_ss_tptc1_enable_clr(&mut self) -> AppSsTptc1EnableClrW<SecEnableClrReg0Spec> {
...
Interrupt Enable Clear Register for app_ss_tptc2_pend - (RW )"]
    #[inline(always)]
    #[must_use]
    pub fn app_ss_tptc2_enable_clr(&mut self) -> AppSsTptc2EnableClrW<SecEnableClrReg0Spec> {
...
Interrupt Enable Clear Register for hwa_tptc1_pend - (RW )"]
    #[inline(always)]
    #[must_use]
    pub fn hwa_tptc1_enable_clr(&mut self) -> HwaTptc1EnableClrW<SecEnableClrReg0Spec> {
...
Interrupt Enable Clear Register for hwa_tptc2_pend - (RW )"]
    #[inline(always)]
    #[must_use]
    pub fn hwa_tptc2_enable_clr(&mut self) -> HwaTptc2EnableClrW<SecEnableClrReg0Spec> {
...
Interrupt Enable Clear Register for shared_mem0_ramecc_pend - (RW )"]
    ...
    pub fn shared_mem0_ramecc_enable_clr(
        &mut self,
    ) -> SharedMem0RameccEnableClrW<SecEnableClrReg0Spec> {
...
Interrupt Enable Clear Register for shared_mem1_ramecc_pend - (RW )"]
    ...
    pub fn shared_mem1_ramecc_enable_clr(
        &mut self,
    ) -> SharedMem1RameccEnableClrW<SecEnableClrReg0Spec> {
...
Interrupt Enable Clear Register for hwa_param_mem_pend - (RW )"]
    #[inline(always)]
    #[must_use]
    pub fn hwa_param_mem_enable_clr(&mut self) -> HwaParamMemEnableClrW<SecEnableClrReg0Spec> {
...
Interrupt Enable Clear Register for shared_mem2_ramecc_pend - (RW )"]
    ...
    pub fn shared_mem2_ramecc_enable_clr(
        &mut self,
    ) -> SharedMem2RameccEnableClrW<SecEnableClrReg0Spec> {
...
Interrupt Enable Clear Register for adcping_ramecc_pend - (RW )"]
    #[inline(always)]
    #[must_use]
    pub fn adcping_ramecc_enable_clr(&mut self) -> AdcpingRameccEnableClrW<SecEnableClrReg0Spec> {
...
Interrupt Enable Clear Register for adcpong_ramecc_pend - (RW )"]
    #[inline(always)]
    #[must_use]
    pub fn adcpong_ramecc_enable_clr(&mut self) -> AdcpongRameccEnableClrW<SecEnableClrReg0Spec> {
...
RESERVE FIELD"]
    #[inline(always)]
    #[must_use]
    pub fn res10(&mut self) -> Res10W<SecEnableClrReg0Spec> {
        Res10W::new(self, 14)
    }
}
