#[doc = "Register `DFOPT0` reader"]
pub type R = crate::R<Dfopt0Spec>;
#[doc = "Register `DFOPT0` writer"]
pub type W = crate::W<Dfopt0Spec>;
...
Source Address Mode within an array:#br#0: INCR Src addressing within an array increments.#br#1: FIFO Src addressing within an array wraps around upon reaching FIFO width."]
    #[inline(always)]
    #[must_use]
    pub fn source_address_mode(&mut self) -> SourceAddressModeW<Dfopt0Spec> {
...
Destination Address Mode within an array:#br#0: INCR Dst addressing within an array increments.#br#1: FIFO Dst addressing within an array wraps around upon reaching FIFO width."]
    #[inline(always)]
    #[must_use]
    pub fn destination_address_mode(&mut self) -> DestinationAddressModeW<Dfopt0Spec> {
...
Transfer Priority:#br#0: Priority 0 - Highest priority#br#1: Priority 1 ...#br#7: Priority 7 - Lowest priority"]
    #[inline(always)]
    #[must_use]
    pub fn transfer_priority(&mut self) -> TransferPriorityW<Dfopt0Spec> {
...
FIFO width control: Applies if either SAM or DAM is set to FIFO mode."]
    #[inline(always)]
    #[must_use]
    pub fn fifo_width_control(&mut self) -> FifoWidthControlW<Dfopt0Spec> {
...
Transfer Complete Code: The 6-bit code is used to set the relevant bit in CER or IPR of the TPCC module."]
    #[inline(always)]
    #[must_use]
    pub fn transfer_complete_code(&mut self) -> TransferCompleteCodeW<Dfopt0Spec> {
...
Transfer complete interrupt enable:#br#0: Transfer complete interrupt is disabled.#br#1: Transfer complete interrupt is enabled."]
    #[inline(always)]
    #[must_use]
    pub fn transfer_complete_interrupt(&mut self) -> TransferCompleteInterruptW<Dfopt0Spec> {
...
Transfer complete chaining enable:#br#0: Transfer complete chaining is disabled.#br#1: Transfer complete chaining is enabled."]
    #[inline(always)]
    #[must_use]
    pub fn transfer_complete_chaining(&mut self) -> TransferCompleteChainingW<Dfopt0Spec> {
...
Debug ID#br#Value driven on the read (tptc_r_dbg_channel_id) and write (tptc_w_dbg_channel_id) command bus.#br#Used at system level for trace/profiling of user selected transfers in systems that include this feature."]
    #[inline(always)]
    #[must_use]
    pub fn debug_id(&mut self) -> DebugIdW<Dfopt0Spec> {
        DebugIdW::new(self, 28)
    }
}
#[doc = "Dst FIFO Set Options\n\nYou can [`read`](crate::Reg::read) this register and get [`dfopt0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dfopt0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Dfopt0Spec;
impl crate::RegisterSpec for Dfopt0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dfopt0::R`](R) reader structure"]
impl crate::Readable for Dfopt0Spec {}
#[doc = "`write(|w| ..)` method takes [`dfopt0::W`](W) writer structure"]
impl crate::Writable for Dfopt0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DFOPT0 to value 0"]
impl crate::Resettable for Dfopt0Spec {
