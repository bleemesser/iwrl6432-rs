...
#[doc = "Field `topss` reader - 29:27\\]
0x0 : Release the reset 0x7 : Assert the reset"]
pub type TopssR = crate::FieldReader;
#[doc = "Field `topss` writer - 29:27\\]
0x0 : Release the reset 0x7 : Assert the reset"]
pub type TopssW<'a, REG> = crate::FieldWriter<'a, REG, 3>;
impl R {
    #[doc = "Bits 0:2 - 2:0\\]
0x0 : Release the reset 0x7 : Assert the reset"]
    #[inline(always)]
...
0x0 : Release the reset 0x7 : Assert the reset"]
    #[inline(always)]
    pub fn topss(&self) -> TopssR {
        TopssR::new(((self.bits >> 27) & 7) as u8)
    }
}
impl W {
    #[doc = "Bits 0:2 - 2:0\\]
0x0 : Release the reset 0x7 : Assert the reset"]
    #[inline(always)]
    #[must_use]
    pub fn app_uart_0(&mut self) -> AppUart0W<Blockreset1Spec> {
...
0x0 : Release the reset 0x7 : Assert the reset"]
    #[inline(always)]
    #[must_use]
    pub fn app_uart_1(&mut self) -> AppUart1W<Blockreset1Spec> {
...
0x0 : Release the reset 0x7 : Assert the reset"]
    #[inline(always)]
    #[must_use]
    pub fn app_spi_0(&mut self) -> AppSpi0W<Blockreset1Spec> {
        AppSpi0W::new(self, 6)
    }
    #[doc = "Bits 9:11 - 11:9\\]
0x0 : Release the reset 0x7 : Assert the reset"]
    #[inline(always)]
    #[must_use]
    pub fn app_spi_1(&mut self) -> AppSpi1W<Blockreset1Spec> {
        AppSpi1W::new(self, 9)
    }
    #[doc = "Bits 12:14 - 14:12\\]
0x0 : Release the reset 0x7 : Assert the reset"]
    #[inline(always)]
    #[must_use]
    pub fn app_can(&mut self) -> AppCanW<Blockreset1Spec> {
        AppCanW::new(self, 12)
    }
    #[doc = "Bits 15:17 - 17:15\\]
0x0 : Release the reset 0x7 : Assert the reset"]
    #[inline(always)]
    #[must_use]
    pub fn app_lin(&mut self) -> AppLinW<Blockreset1Spec> {
        AppLinW::new(self, 15)
    }
    #[doc = "Bits 18:20 - 20:18\\]
0x0 : Release the reset 0x7 : Assert the reset"]
    #[inline(always)]
    #[must_use]
    pub fn app_pwm(&mut self) -> AppPwmW<Blockreset1Spec> {
        AppPwmW::new(self, 18)
    }
    #[doc = "Bits 21:23 - 23:21\\]
0x0 : Release the reset 0x7 : Assert the reset"]
    #[inline(always)]
    #[must_use]
    pub fn app_crc(&mut self) -> AppCrcW<Blockreset1Spec> {
        AppCrcW::new(self, 21)
    }
    #[doc = "Bits 24:26 - 26:24\\]
0x0 : Release the reset 0x7 : Assert the reset"]
    #[inline(always)]
    #[must_use]
    pub fn app_ctrl(&mut self) -> AppCtrlW<Blockreset1Spec> {
...
0x0 : Release the reset 0x7 : Assert the reset"]
    #[inline(always)]
    #[must_use]
    pub fn topss(&mut self) -> TopssW<Blockreset1Spec> {
        TopssW::new(self, 27)
    }
}
