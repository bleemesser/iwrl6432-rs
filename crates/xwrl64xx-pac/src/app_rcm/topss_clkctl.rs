#[doc = "Register `TOPSS_CLKCTL` reader"]
pub type R = crate::R<TopssClkctlSpec>;
#[doc = "Register `TOPSS_CLKCTL` writer"]
...
0x0 : OSC_CLK 0x1 : SLOW_CLK 0x2 : MDLL 0x3 : FAST_CLK 0x4 : SLOW_CLK For other values if the lower 3 bits matches with above, corresponding clock is selected. Data should be loaded as multibit. For example: if Clock source 0x5 should be selected then 0x555 should be configured to the register."]
...
#[doc = "`read()` method returns [`topss_clkctl::R`](R) reader structure"]
impl crate::Readable for TopssClkctlSpec {}
#[doc = "`write(|w| ..)` method takes [`topss_clkctl::W`](W) writer structure"]
impl crate::Writable for TopssClkctlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets TOPSS_CLKCTL to value 0"]
