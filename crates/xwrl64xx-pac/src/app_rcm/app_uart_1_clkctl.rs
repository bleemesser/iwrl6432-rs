#[doc = "Register `APP_UART_1_CLKCTL` reader"]
pub type R = crate::R<AppUart1ClkctlSpec>;
#[doc = "Register `APP_UART_1_CLKCTL` writer"]
pub type W = crate::W<AppUart1ClkctlSpec>;
...
0x0 : Enable the Clock 0x7 : Gate the clock"]
    #[inline(always)]
    #[must_use]
    pub fn gate(&mut self) -> GateW<AppUart1ClkctlSpec> {
        GateW::new(self, 0)
    }
    #[doc = "Bits 16:27 - 27:16\\]
Divide value 0x0 : div1 0x1 : div2 0x2 : div3 . . 0xF = div16 Data should be loaded as multibit. For example: if divider value of '0x8' should be selected then '0x888' should be configured to the register."]
    #[inline(always)]
    #[must_use]
    pub fn divr(&mut self) -> DivrW<AppUart1ClkctlSpec> {
        DivrW::new(self, 16)
    }
}
...
pub struct AppUart1ClkctlSpec;
impl crate::RegisterSpec for AppUart1ClkctlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`app_uart_1_clkctl::R`](R) reader structure"]
impl crate::Readable for AppUart1ClkctlSpec {}
#[doc = "`write(|w| ..)` method takes [`app_uart_1_clkctl::W`](W) writer structure"]
impl crate::Writable for AppUart1ClkctlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets APP_UART_1_CLKCTL to value 0"]
impl crate::Resettable for AppUart1ClkctlSpec {
