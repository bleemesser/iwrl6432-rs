#[doc = "Register `APP_LIN_CLKCTL` reader"]
pub type R = crate::R<AppLinClkctlSpec>;
#[doc = "Register `APP_LIN_CLKCTL` writer"]
...
0x0 : Enable the Clock 0x7 : Gate the clock"]
    #[inline(always)]
    #[must_use]
    pub fn gate(&mut self) -> GateW<AppLinClkctlSpec> {
        GateW::new(self, 0)
    }
    #[doc = "Bits 16:27 - 27:16\\]
Divide value 0x0 : div1 0x1 : div2 0x2 : div3 . . 0xF = div16 Data should be loaded as multibit. For example: if divider value of '0x8' should be selected then '0x888' should be configured to the register."]
    #[inline(always)]
    #[must_use]
    pub fn divr(&mut self) -> DivrW<AppLinClkctlSpec> {
        DivrW::new(self, 16)
    }
}
...
pub struct AppLinClkctlSpec;
impl crate::RegisterSpec for AppLinClkctlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`app_lin_clkctl::R`](R) reader structure"]
impl crate::Readable for AppLinClkctlSpec {}
#[doc = "`write(|w| ..)` method takes [`app_lin_clkctl::W`](W) writer structure"]
impl crate::Writable for AppLinClkctlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets APP_LIN_CLKCTL to value 0"]
impl crate::Resettable for AppLinClkctlSpec {
