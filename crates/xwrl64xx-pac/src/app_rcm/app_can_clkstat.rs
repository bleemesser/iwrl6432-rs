#[doc = "Register `APP_CAN_CLKSTAT` reader"]
pub type R = crate::R<AppCanClkstatSpec>;
#[doc = "Register `APP_CAN_CLKSTAT` writer"]
pub type W = crate::W<AppCanClkstatSpec>;
...
Gives the current divr setting used by the clock divider."]
    #[inline(always)]
    #[must_use]
    pub fn currdivr(&mut self) -> CurrdivrW<AppCanClkstatSpec> {
...
Current Clock selected by GCM Clock Mux 0x1 : XTALCLK 0x2 : XTALCLKX2 0x4 : MDLL 0x8 : APLL/DPLL 0x10 : RCCLK"]
    #[inline(always)]
    #[must_use]
    pub fn currclk(&mut self) -> CurrclkW<AppCanClkstatSpec> {
        CurrclkW::new(self, 4)
    }
}
...
pub struct AppCanClkstatSpec;
impl crate::RegisterSpec for AppCanClkstatSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`app_can_clkstat::R`](R) reader structure"]
impl crate::Readable for AppCanClkstatSpec {}
#[doc = "`write(|w| ..)` method takes [`app_can_clkstat::W`](W) writer structure"]
impl crate::Writable for AppCanClkstatSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets APP_CAN_CLKSTAT to value 0"]
impl crate::Resettable for AppCanClkstatSpec {
