...
0x0 : Release the reset#br#0x7 : Assert the reset"]
    #[inline(always)]
    #[must_use]
    pub fn res(&mut self) -> ResW<Blockreset0Spec> {
        ResW::new(self, 0)
    }
    #[doc = "Bits 3:5 - 5:3\\]
0x0 : Release the reset#br#0x7 : Assert the reset"]
    #[inline(always)]
    #[must_use]
    pub fn qspi(&mut self) -> QspiW<Blockreset0Spec> {
        QspiW::new(self, 3)
    }
    #[doc = "Bits 6:8 - 8:6\\]
0x0 : Release the reset#br#0x7 : Assert the reset"]
    #[inline(always)]
    #[must_use]
    pub fn tptc1(&mut self) -> Tptc1W<Blockreset0Spec> {
        Tptc1W::new(self, 6)
    }
    #[doc = "Bits 9:11 - 11:9\\]
0x0 : Release the reset#br#0x7 : Assert the reset"]
    #[inline(always)]
    #[must_use]
    pub fn tptc2(&mut self) -> Tptc2W<Blockreset0Spec> {
        Tptc2W::new(self, 9)
    }
    #[doc = "Bits 12:14 - 14:12\\]
0x0 : Release the reset#br#0x7 : Assert the reset"]
    #[inline(always)]
    #[must_use]
    pub fn tpcc(&mut self) -> TpccW<Blockreset0Spec> {
        TpccW::new(self, 12)
    }
    #[doc = "Bits 15:17 - 17:15\\]
0x0 : Release the reset#br#0x7 : Assert the reset"]
    #[inline(always)]
    #[must_use]
    pub fn esm(&mut self) -> EsmW<Blockreset0Spec> {
        EsmW::new(self, 15)
    }
    #[doc = "Bits 18:20 - 20:18\\]
0x0 : Release the reset#br#0x7 : Assert the reset"]
    #[inline(always)]
    #[must_use]
    pub fn rti(&mut self) -> RtiW<Blockreset0Spec> {
        RtiW::new(self, 18)
    }
    #[doc = "Bits 21:23 - 23:21\\]
0x0 : Release the reset#br#0x7 : Assert the reset"]
    #[inline(always)]
    #[must_use]
    pub fn wdt(&mut self) -> WdtW<Blockreset0Spec> {
        WdtW::new(self, 21)
    }
    #[doc = "Bits 24:26 - 26:24\\]
0x0 : Release the reset#br#0x7 : Assert the reset"]
    #[inline(always)]
    #[must_use]
    pub fn dcc(&mut self) -> DccW<Blockreset0Spec> {
        DccW::new(self, 24)
    }
    #[doc = "Bits 27:29 - 29:27\\]
0x0 : Release the reset#br#0x7 : Assert the reset"]
    #[inline(always)]
    #[must_use]
    pub fn i2c(&mut self) -> I2cW<Blockreset0Spec> {
        I2cW::new(self, 27)
    }
}
