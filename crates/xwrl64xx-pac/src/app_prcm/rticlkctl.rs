#[doc = "Register `RTICLKCTL` reader"]
pub type R = crate::R<RticlkctlSpec>;
#[doc = "Register `RTICLKCTL` writer"]
pub type W = crate::W<RticlkctlSpec>;
#[doc = "Field `srcsel` reader - 3:0\\]
0x0 : XTALCLK#br#0x1 : REFCLK#br#For other values if the lower 3 bits matches with above, corresponding clock is selected."]
...
0x0 : XTALCLK#br#0x1 : REFCLK#br#For other values if the lower 3 bits matches with above, corresponding clock is selected."]
    #[inline(always)]
    #[must_use]
    pub fn srcsel(&mut self) -> SrcselW<RticlkctlSpec> {
        SrcselW::new(self, 0)
    }
    #[doc = "Bits 4:7 - 7:4\\]
0x0 : Enable the Clock#br#0x7 : Gate the clock"]
    #[inline(always)]
    #[must_use]
    pub fn gate(&mut self) -> GateW<RticlkctlSpec> {
        GateW::new(self, 4)
    }
    #[doc = "Bits 8:11 - 11:8\\]
Divide value#br#0x0 : div1#br#0x1 : div2#br#0x2 : div3#br#.#br#.#br#0xF = div16"]
    #[inline(always)]
    #[must_use]
    pub fn divr(&mut self) -> DivrW<RticlkctlSpec> {
        DivrW::new(self, 8)
    }
    #[doc = "Bit 12 - 12:12\\]
1'b1 : Switch to the new divide ratio set by divr bits above. This happens when output clock of the divider is transitioning from 0->1,"]
    #[inline(always)]
    #[must_use]
    pub fn switchen(&mut self) -> SwitchenW<RticlkctlSpec> {
...
Gives the current divr setting used by the clock divider."]
    #[inline(always)]
    #[must_use]
    pub fn currdivr(&mut self) -> CurrdivrW<RticlkctlSpec> {
...
Current Clock selected by GCM Clock Mux#br#0x1 : XTALCLK#br#0x2 : XTALCLKX2#br#0x4 : MDLL#br#0x8 : APLL/DPLL#br#0x10 : RCCLK"]
    #[inline(always)]
    #[must_use]
    pub fn currclk(&mut self) -> CurrclkW<RticlkctlSpec> {
        CurrclkW::new(self, 24)
    }
}
#[doc = "RTICLKCTL\n\nYou can [`read`](crate::Reg::read) this register and get [`rticlkctl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rticlkctl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct RticlkctlSpec;
impl crate::RegisterSpec for RticlkctlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`rticlkctl::R`](R) reader structure"]
impl crate::Readable for RticlkctlSpec {}
#[doc = "`write(|w| ..)` method takes [`rticlkctl::W`](W) writer structure"]
impl crate::Writable for RticlkctlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets RTICLKCTL to value 0"]
impl crate::Resettable for RticlkctlSpec {
