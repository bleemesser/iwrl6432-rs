#[doc = "Register `LINCLKCTL` reader"]
pub type R = crate::R<LinclkctlSpec>;
#[doc = "Register `LINCLKCTL` writer"]
pub type W = crate::W<LinclkctlSpec>;
...
0x0 : Enable the Clock#br#0x7 : Gate the clock"]
    #[inline(always)]
    #[must_use]
    pub fn gate(&mut self) -> GateW<LinclkctlSpec> {
        GateW::new(self, 4)
    }
    #[doc = "Bits 8:11 - 11:8\\]
Divide value#br#0x0 : div1#br#0x1 : div2#br#0x2 : div3#br#.#br#.#br#0xF = div16"]
    #[inline(always)]
    #[must_use]
    pub fn divr(&mut self) -> DivrW<LinclkctlSpec> {
        DivrW::new(self, 8)
    }
    #[doc = "Bit 12 - 12:12\\]
1'b1 : Switch to the new divide ratio set by divr bits above. This happens when output clock of the divider is transitioning from 0->1,"]
    #[inline(always)]
    #[must_use]
    pub fn switchen(&mut self) -> SwitchenW<LinclkctlSpec> {
...
Gives the current divr setting used by the clock divider."]
    #[inline(always)]
    #[must_use]
    pub fn currdivr(&mut self) -> CurrdivrW<LinclkctlSpec> {
        CurrdivrW::new(self, 16)
    }
}
#[doc = "LINCLKCTL\n\nYou can [`read`](crate::Reg::read) this register and get [`linclkctl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`linclkctl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct LinclkctlSpec;
impl crate::RegisterSpec for LinclkctlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`linclkctl::R`](R) reader structure"]
impl crate::Readable for LinclkctlSpec {}
#[doc = "`write(|w| ..)` method takes [`linclkctl::W`](W) writer structure"]
impl crate::Writable for LinclkctlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets LINCLKCTL to value 0"]
impl crate::Resettable for LinclkctlSpec {
