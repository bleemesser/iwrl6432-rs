#[doc = "Register `QSPICLKCTL` reader"]
pub type R = crate::R<QspiclkctlSpec>;
#[doc = "Register `QSPICLKCTL` writer"]
pub type W = crate::W<QspiclkctlSpec>;
...
0x0 : XTALCLK#br#0x1 : XTALCLKX2#br#0x2 : MDLL#br#0x3 : APLL/DPLL#br#0x4 : RCCLK#br#For other values if the lower 3 bits matches with above, corresponding clock is selected."]
    #[inline(always)]
    #[must_use]
    pub fn srcsel(&mut self) -> SrcselW<QspiclkctlSpec> {
        SrcselW::new(self, 0)
    }
    #[doc = "Bits 4:7 - 7:4\\]
0x0 : Enable the Clock#br#0x7 : Gate the clock"]
    #[inline(always)]
    #[must_use]
    pub fn gate(&mut self) -> GateW<QspiclkctlSpec> {
        GateW::new(self, 4)
    }
    #[doc = "Bits 8:11 - 11:8\\]
Divide value#br#0x0 : div1#br#0x1 : div2#br#0x2 : div3#br#.#br#.#br#0xF = div16"]
    #[inline(always)]
    #[must_use]
    pub fn divr(&mut self) -> DivrW<QspiclkctlSpec> {
        DivrW::new(self, 8)
    }
    #[doc = "Bit 12 - 12:12\\]
1'b1 : Switch to the new divide ratio set by divr bits above. This happens when output clock of the divider is transitioning from 0->1,"]
    #[inline(always)]
    #[must_use]
    pub fn switchen(&mut self) -> SwitchenW<QspiclkctlSpec> {
...
Gives the current divr setting used by the clock divider."]
    #[inline(always)]
    #[must_use]
    pub fn currdivr(&mut self) -> CurrdivrW<QspiclkctlSpec> {
...
Current Clock selected by GCM Clock Mux#br#0x1 : XTALCLK#br#0x2 : XTALCLKX2#br#0x4 : MDLL#br#0x8 : APLL/DPLL#br#0x10 : RCCLK"]
    #[inline(always)]
    #[must_use]
    pub fn currclk(&mut self) -> CurrclkW<QspiclkctlSpec> {
        CurrclkW::new(self, 24)
    }
}
#[doc = "QSPICLKCTL\n\nYou can [`read`](crate::Reg::read) this register and get [`qspiclkctl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`qspiclkctl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct QspiclkctlSpec;
impl crate::RegisterSpec for QspiclkctlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`qspiclkctl::R`](R) reader structure"]
impl crate::Readable for QspiclkctlSpec {}
#[doc = "`write(|w| ..)` method takes [`qspiclkctl::W`](W) writer structure"]
impl crate::Writable for QspiclkctlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets QSPICLKCTL to value 0"]
impl crate::Resettable for QspiclkctlSpec {
