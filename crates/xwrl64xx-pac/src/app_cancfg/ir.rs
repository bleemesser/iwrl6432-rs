...
#[doc = "Field `BEC` reader - 20:20\\]
Bit Error Corrected"]
pub type BecR = crate::BitReader;
#[doc = "Field `BEC` writer - 20:20\\]
Bit Error Corrected"]
...
#[doc = "Field `NU30` reader - 31:30\\]
Reserved"]
pub type Nu30R = crate::FieldReader;
#[doc = "Field `NU30` writer - 31:30\\]
Reserved"]
pub type Nu30W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
impl R {
    #[doc = "Bit 0 - 0:0\\]
Rx FIFO 0 New Message"]
    #[inline(always)]
...
Reserved"]
    ...
    pub fn nu30(&self) -> Nu30R {
        Nu30R::new(((self.bits >> 30) & 3) as u8)
    }
}
impl W {
    #[doc = "Bit 0 - 0:0\\]
...
Reserved"]
    #[inline(always)]
    #[must_use]
    pub fn nu30(&mut self) -> Nu30W<IrSpec> {
        Nu30W::new(self, 30)
    }
}
