...
pub type R = crate::R<Ch2statSpec>;
#[doc = "Register `CH2STAT` writer"]
pub type W = crate::W<Ch2statSpec>;
...
Channel \"i\" Receiver Register Status - (RO )"]
    #[inline(always)]
    #[must_use]
    pub fn rxs(&mut self) -> RxsW<Ch2statSpec> {
        RxsW::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
Channel \"i\" Transmitter Register Status - (RO )"]
    #[inline(always)]
    #[must_use]
    pub fn txs(&mut self) -> TxsW<Ch2statSpec> {
        TxsW::new(self, 1)
    }
    #[doc = "Bit 2 - 2:2\\]
Channel \"i\" End of transfer Status The definitions of beginning and end of transfer vary with master versus slave and the transfer format \\[Transmit/Receive modes Turbo mode\\]
See dedicated chapters for details - (RO )"]
    #[inline(always)]
    #[must_use]
    pub fn eot(&mut self) -> EotW<Ch2statSpec> {
        EotW::new(self, 2)
    }
    #[doc = "Bit 3 - 3:3\\]
Channel \"i\" FIFO Transmit Buffer Empty Status - (RO )"]
    #[inline(always)]
    #[must_use]
    pub fn txffe(&mut self) -> TxffeW<Ch2statSpec> {
        TxffeW::new(self, 3)
    }
    #[doc = "Bit 4 - 4:4\\]
Channel \"i\" FIFO Transmit Buffer Full Status - (RO )"]
    #[inline(always)]
    #[must_use]
    pub fn txfff(&mut self) -> TxfffW<Ch2statSpec> {
        TxfffW::new(self, 4)
    }
    #[doc = "Bit 5 - 5:5\\]
Channel \"i\" FIFO Receive Buffer Empty Status - (RO )"]
    #[inline(always)]
    #[must_use]
    pub fn rxffe(&mut self) -> RxffeW<Ch2statSpec> {
        RxffeW::new(self, 5)
    }
    #[doc = "Bit 6 - 6:6\\]
Channel \"i\" FIFO Receive Buffer Full Status - (RO )"]
    #[inline(always)]
    #[must_use]
    pub fn rxfff(&mut self) -> RxfffW<Ch2statSpec> {
        RxfffW::new(self, 6)
    }
    #[doc = "Bits 7:31 - 31:7\\]
Read returns 0 - (RO )"]
    #[inline(always)]
    #[must_use]
    pub fn reserved_2(&mut self) -> Reserved2W<Ch2statSpec> {
        Reserved2W::new(self, 7)
    }
}
#[doc = "This register provides status information about transmitter and receiver registers of channel 2\n\nYou can [`read`](crate::Reg::read) this register and get [`ch2stat::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ch2stat::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ch2statSpec;
impl crate::RegisterSpec for Ch2statSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch2stat::R`](R) reader structure"]
impl crate::Readable for Ch2statSpec {}
#[doc = "`write(|w| ..)` method takes [`ch2stat::W`](W) writer structure"]
impl crate::Writable for Ch2statSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CH2STAT to value 0"]
impl crate::Resettable for Ch2statSpec {
