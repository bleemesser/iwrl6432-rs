...
#[doc = "Field `hwreg4` reader - 31:0\\]
HW reserved Regsiter"]
pub type Hwreg4R = crate::FieldReader<u32>;
#[doc = "Field `hwreg4` writer - 31:0\\]
HW reserved Regsiter"]
pub type Hwreg4W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - 31:0\\]
HW reserved Regsiter"]
    #[inline(always)]
    pub fn hwreg4(&self) -> Hwreg4R {
        Hwreg4R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - 31:0\\]
HW reserved Regsiter"]
    #[inline(always)]
    #[must_use]
    pub fn hwreg4(&mut self) -> Hwreg4W<HwReg4Spec> {
        Hwreg4W::new(self, 0)
    }
}
