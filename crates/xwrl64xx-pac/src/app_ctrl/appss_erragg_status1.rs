#[doc = "Register `APPSS_ERRAGG_STATUS1` reader"]
pub type R = crate::R<AppssErraggStatus1Spec>;
#[doc = "Register `APPSS_ERRAGG_STATUS1` writer"]
pub type W = crate::W<AppssErraggStatus1Spec>;
#[doc = "Field `cluster1_power_down_access_err` reader - 0:0\\]
Status of Interrupt from cluster1_power_down_access_err Set only if Interupt is unmasked in APPSS_ERRAGG_MASK1 Wrie 0x1 to clear this interrupt."]
...
Status of Interrupt from cluster2_power_down_access_err Set only if Interupt is unmasked in APPSS_ERRAGG_MASK1 Wrie 0x1 to clear this interrupt."]
...
Status of Interrupt from cluster3_power_down_access_err Set only if Interupt is unmasked in APPSS_ERRAGG_MASK1 Wrie 0x1 to clear this interrupt."]
...
Status of Interrupt from cluster4_power_down_access_err Set only if Interupt is unmasked in APPSS_ERRAGG_MASK1 Wrie 0x1 to clear this interrupt."]
...
Status of Interrupt from cluster5_power_down_access_err Set only if Interupt is unmasked in APPSS_ERRAGG_MASK1 Wrie 0x1 to clear this interrupt."]
...
Status of Interrupt from cluster6_power_down_access_err Set only if Interupt is unmasked in APPSS_ERRAGG_MASK1 Wrie 0x1 to clear this interrupt."]
...
Status of Interrupt from cluster7_power_down_access_err Set only if Interupt is unmasked in APPSS_ERRAGG_MASK1 Wrie 0x1 to clear this interrupt."]
...
Status of Interrupt from cluster8_power_down_access_err Set only if Interupt is unmasked in APPSS_ERRAGG_MASK1 Wrie 0x1 to clear this interrupt."]
...
Status of Interrupt from cluster9_power_down_access_err Set only if Interupt is unmasked in APPSS_ERRAGG_MASK1 Wrie 0x1 to clear this interrupt."]
...
Status of Interrupt from cluster10_power_down_access_err Set only if Interupt is unmasked in APPSS_ERRAGG_MASK1 Wrie 0x1 to clear this interrupt."]
...
Status of Interrupt from cluster11_power_down_access_err Set only if Interupt is unmasked in APPSS_ERRAGG_MASK1 Wrie 0x1 to clear this interrupt."]
...
Status of Interrupt from cluster12_power_down_access_err Set only if Interupt is unmasked in APPSS_ERRAGG_MASK1 Wrie 0x1 to clear this interrupt."]
...
Status of Interrupt from cluster1_power_down_access_err Set only if Interupt is unmasked in APPSS_ERRAGG_MASK1 Wrie 0x1 to clear this interrupt."]
    ...
    pub fn cluster1_power_down_access_err(
        &mut self,
    ) -> Cluster1PowerDownAccessErrW<AppssErraggStatus1Spec> {
...
Status of Interrupt from cluster2_power_down_access_err Set only if Interupt is unmasked in APPSS_ERRAGG_MASK1 Wrie 0x1 to clear this interrupt."]
    ...
    pub fn cluster2_power_down_access_err(
        &mut self,
    ) -> Cluster2PowerDownAccessErrW<AppssErraggStatus1Spec> {
...
Status of Interrupt from cluster3_power_down_access_err Set only if Interupt is unmasked in APPSS_ERRAGG_MASK1 Wrie 0x1 to clear this interrupt."]
    ...
    pub fn cluster3_power_down_access_err(
        &mut self,
    ) -> Cluster3PowerDownAccessErrW<AppssErraggStatus1Spec> {
...
Status of Interrupt from cluster4_power_down_access_err Set only if Interupt is unmasked in APPSS_ERRAGG_MASK1 Wrie 0x1 to clear this interrupt."]
    ...
    pub fn cluster4_power_down_access_err(
        &mut self,
    ) -> Cluster4PowerDownAccessErrW<AppssErraggStatus1Spec> {
...
Status of Interrupt from cluster5_power_down_access_err Set only if Interupt is unmasked in APPSS_ERRAGG_MASK1 Wrie 0x1 to clear this interrupt."]
    ...
    pub fn cluster5_power_down_access_err(
        &mut self,
    ) -> Cluster5PowerDownAccessErrW<AppssErraggStatus1Spec> {
...
Status of Interrupt from cluster6_power_down_access_err Set only if Interupt is unmasked in APPSS_ERRAGG_MASK1 Wrie 0x1 to clear this interrupt."]
    ...
    pub fn cluster6_power_down_access_err(
        &mut self,
    ) -> Cluster6PowerDownAccessErrW<AppssErraggStatus1Spec> {
...
Status of Interrupt from cluster7_power_down_access_err Set only if Interupt is unmasked in APPSS_ERRAGG_MASK1 Wrie 0x1 to clear this interrupt."]
    ...
    pub fn cluster7_power_down_access_err(
        &mut self,
    ) -> Cluster7PowerDownAccessErrW<AppssErraggStatus1Spec> {
...
Status of Interrupt from cluster8_power_down_access_err Set only if Interupt is unmasked in APPSS_ERRAGG_MASK1 Wrie 0x1 to clear this interrupt."]
    ...
    pub fn cluster8_power_down_access_err(
        &mut self,
    ) -> Cluster8PowerDownAccessErrW<AppssErraggStatus1Spec> {
...
Status of Interrupt from cluster9_power_down_access_err Set only if Interupt is unmasked in APPSS_ERRAGG_MASK1 Wrie 0x1 to clear this interrupt."]
    ...
    pub fn cluster9_power_down_access_err(
        &mut self,
    ) -> Cluster9PowerDownAccessErrW<AppssErraggStatus1Spec> {
...
Status of Interrupt from cluster10_power_down_access_err Set only if Interupt is unmasked in APPSS_ERRAGG_MASK1 Wrie 0x1 to clear this interrupt."]
    ...
    pub fn cluster10_power_down_access_err(
        &mut self,
    ) -> Cluster10PowerDownAccessErrW<AppssErraggStatus1Spec> {
...
Status of Interrupt from cluster11_power_down_access_err Set only if Interupt is unmasked in APPSS_ERRAGG_MASK1 Wrie 0x1 to clear this interrupt."]
    ...
    pub fn cluster11_power_down_access_err(
        &mut self,
    ) -> Cluster11PowerDownAccessErrW<AppssErraggStatus1Spec> {
...
Status of Interrupt from cluster12_power_down_access_err Set only if Interupt is unmasked in APPSS_ERRAGG_MASK1 Wrie 0x1 to clear this interrupt."]
    ...
    pub fn cluster12_power_down_access_err(
        &mut self,
    ) -> Cluster12PowerDownAccessErrW<AppssErraggStatus1Spec> {
...
pub struct AppssErraggStatus1Spec;
impl crate::RegisterSpec for AppssErraggStatus1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`appss_erragg_status1::R`](R) reader structure"]
impl crate::Readable for AppssErraggStatus1Spec {}
#[doc = "`write(|w| ..)` method takes [`appss_erragg_status1::W`](W) writer structure"]
impl crate::Writable for AppssErraggStatus1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets APPSS_ERRAGG_STATUS1 to value 0"]
impl crate::Resettable for AppssErraggStatus1Spec {
