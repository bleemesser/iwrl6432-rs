#[doc = "Register `CRC_CURSEC_REG2` reader"]
pub type R = crate::R<CrcCursecReg2Spec>;
#[doc = "Register `CRC_CURSEC_REG2` writer"]
pub type W = crate::W<CrcCursecReg2Spec>;
...
Channel 2 Current Sector ID Register. In AUTO mode, this register contains the current sector number of which the signature verification fails. The sector counter is a free running up counter. When a sector fails, the erroneous sector number is logged into current sector ID register and the CRC fail interrupt is generated The sector ID register is frozen until it is read and the CRC fail status bit is cleared by CPU. While it is frozen, it does not capture another erroneous sector number. When this condition happens, an overrun interrupt is generated instead. Once the register is read and the CRC fail interrupt flag is cleared it can capture new erro- neous sector number."]
    #[inline(always)]
    #[must_use]
    pub fn crc_cursec2(&mut self) -> CrcCursec2W<CrcCursecReg2Spec> {
...
Reserved"]
    #[inline(always)]
    #[must_use]
    pub fn reserved1(&mut self) -> Reserved1W<CrcCursecReg2Spec> {
...
pub struct CrcCursecReg2Spec;
impl crate::RegisterSpec for CrcCursecReg2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`crc_cursec_reg2::R`](R) reader structure"]
impl crate::Readable for CrcCursecReg2Spec {}
#[doc = "`write(|w| ..)` method takes [`crc_cursec_reg2::W`](W) writer structure"]
impl crate::Writable for CrcCursecReg2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CRC_CURSEC_REG2 to value 0"]
impl crate::Resettable for CrcCursecReg2Spec {
