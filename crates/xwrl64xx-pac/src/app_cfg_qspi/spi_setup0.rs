#[doc = "Register `SPI_SETUP0` reader"]
pub type R = crate::R<SpiSetup0Spec>;
#[doc = "Register `SPI_SETUP0` writer"]
pub type W = crate::W<SpiSetup0Spec>;
...
Read Command"]
    #[inline(always)]
    #[must_use]
    pub fn rcmd(&mut self) -> RcmdW<SpiSetup0Spec> {
        RcmdW::new(self, 0)
    }
    #[doc = "Bits 8:9 - 9:8\\]
Number of address bytes to be sent. 0 = 1 byte; 1 = 2 bytes; 2 = 3 bytes; 3 = 4 bytes"]
    #[inline(always)]
    #[must_use]
    pub fn num_a_bytes(&mut self) -> NumABytesW<SpiSetup0Spec> {
...
Number of dummy bytes to be used for fast read. 0 = use the value in NUM_D_BITS 1 = use 8 bits; 2 = use 16 bits; 3 = use 24 bits"]
    #[inline(always)]
    #[must_use]
    pub fn num_d_bytes(&mut self) -> NumDBytesW<SpiSetup0Spec> {
...
Determines if the read command is a single, dual or quad read mode command 00 ΓÇô Normal read (all data input on spi_din) 01 ΓÇô Dual read (odd bytes input on spi_din; even on spi_dout) 10 ΓÇô Normal read (all data input on spi_din) 11 ΓÇô Quad read (uses spi_qdin0/1)"]
    #[inline(always)]
    #[must_use]
    pub fn read_type(&mut self) -> ReadTypeW<SpiSetup0Spec> {
...
Always read as 0"]
    #[inline(always)]
    #[must_use]
    pub fn reserved1(&mut self) -> Reserved1W<SpiSetup0Spec> {
...
Write Command"]
    #[inline(always)]
    #[must_use]
    pub fn wcmd(&mut self) -> WcmdW<SpiSetup0Spec> {
        WcmdW::new(self, 16)
    }
    #[doc = "Bits 24:28 - 28:24\\]
Number of dummy bits to use if NUM_D_BYTES = 0"]
    #[inline(always)]
    #[must_use]
    pub fn num_d_bits(&mut self) -> NumDBitsW<SpiSetup0Spec> {
...
Always read as 0"]
    #[inline(always)]
    #[must_use]
    pub fn reserved2(&mut self) -> Reserved2W<SpiSetup0Spec> {
        Reserved2W::new(self, 29)
    }
}
#[doc = "Memory Mapped SPI Setup0 Register\n\nYou can [`read`](crate::Reg::read) this register and get [`spi_setup0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`spi_setup0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SpiSetup0Spec;
impl crate::RegisterSpec for SpiSetup0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`spi_setup0::R`](R) reader structure"]
impl crate::Readable for SpiSetup0Spec {}
#[doc = "`write(|w| ..)` method takes [`spi_setup0::W`](W) writer structure"]
impl crate::Writable for SpiSetup0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SPI_SETUP0 to value 0"]
impl crate::Resettable for SpiSetup0Spec {
