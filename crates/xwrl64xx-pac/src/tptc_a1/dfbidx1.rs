#[doc = "Register `DFBIDX1` reader"]
pub type R = crate::R<Dfbidx1Spec>;
#[doc = "Register `DFBIDX1` writer"]
pub type W = crate::W<Dfbidx1Spec>;
...
Src B-Idx for Dest FIFO Register Set.#br#Value copied from PBIDX: B-Idx offset between Source arrays: Represents the offset in bytes between the starting address of each source array \\[recall that there are BCNT arrays of ACNT elements\\].#br#SBIDX is always used regardless of whether SAM is Increment or FIFO mode."]
    #[inline(always)]
    #[must_use]
    pub fn src_bidx_for(&mut self) -> SrcBidxForW<Dfbidx1Spec> {
...
Dest B-Idx for Dest FIFO Register Set.#br#Value copied from PBIDX: B-Idx offset between Destination arrays: Represents the offset in bytes between the starting address of each destination array \\[recall that there are BCNT arrays of ACNT elements\\].#br#DBIDX is always used regardless of whether DAM is Increment or FIFO mode."]
    #[inline(always)]
    #[must_use]
    pub fn dest_bidx_for(&mut self) -> DestBidxForW<Dfbidx1Spec> {
        DestBidxForW::new(self, 16)
    }
}
#[doc = "Dst FIFO Set B-Dim Idx\n\nYou can [`read`](crate::Reg::read) this register and get [`dfbidx1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dfbidx1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Dfbidx1Spec;
impl crate::RegisterSpec for Dfbidx1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dfbidx1::R`](R) reader structure"]
impl crate::Readable for Dfbidx1Spec {}
#[doc = "`write(|w| ..)` method takes [`dfbidx1::W`](W) writer structure"]
impl crate::Writable for Dfbidx1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DFBIDX1 to value 0"]
impl crate::Resettable for Dfbidx1Spec {
