#[doc = "Register `CH2CONF` reader"]
pub type R = crate::R<Ch2confSpec>;
#[doc = "Register `CH2CONF` writer"]
pub type W = crate::W<Ch2confSpec>;
...
SPICLK phase - (RW )"]
    #[inline(always)]
    #[must_use]
    pub fn pha(&mut self) -> PhaW<Ch2confSpec> {
        PhaW::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
SPICLK polarity - (RW )"]
    #[inline(always)]
    #[must_use]
    pub fn pol(&mut self) -> PolW<Ch2confSpec> {
        PolW::new(self, 1)
    }
    #[doc = "Bits 2:5 - 5:2\\]
Frequency divider for SPICLK \\[only when the module is a Master SPI device\\]
...
is set to 0 - (RW )"]
    #[inline(always)]
    #[must_use]
    pub fn clkd(&mut self) -> ClkdW<Ch2confSpec> {
        ClkdW::new(self, 2)
    }
    #[doc = "Bit 6 - 6:6\\]
SPIEN polarity - (RW )"]
    #[inline(always)]
    #[must_use]
    pub fn epol(&mut self) -> EpolW<Ch2confSpec> {
        EpolW::new(self, 6)
    }
    #[doc = "Bits 7:11 - 11:7\\]
SPI word length - (RW )"]
    #[inline(always)]
    #[must_use]
    pub fn wl(&mut self) -> WlW<Ch2confSpec> {
        WlW::new(self, 7)
    }
    #[doc = "Bits 12:13 - 13:12\\]
Transmit/Receive modes - (RW )"]
    #[inline(always)]
    #[must_use]
    pub fn trm(&mut self) -> TrmW<Ch2confSpec> {
        TrmW::new(self, 12)
    }
    #[doc = "Bit 14 - 14:14\\]
DMA Write request The DMA Write request line is asserted when The channel is enabled and the transmitter register of the channel is empty The DMA Write request line is deasserted on load completion of the transmitter register of the channel - (RW )"]
    #[inline(always)]
    #[must_use]
    pub fn dmaw(&mut self) -> DmawW<Ch2confSpec> {
        DmawW::new(self, 14)
    }
    #[doc = "Bit 15 - 15:15\\]
DMA Read request The DMA Read request line is asserted when the channel is enabled and a new data is available in the receive register of the channel The DMA Read request line is deasserted on read completion of the receive register of the channel - (RW )"]
    #[inline(always)]
    #[must_use]
    pub fn dmar(&mut self) -> DmarW<Ch2confSpec> {
        DmarW::new(self, 15)
    }
    #[doc = "Bit 16 - 16:16\\]
Transmission Enable for data line 0 \\[SPIDATAGZEN\\[0\\]\\]
- (RW )"]
    #[inline(always)]
    #[must_use]
    pub fn dpe0(&mut self) -> Dpe0W<Ch2confSpec> {
        Dpe0W::new(self, 16)
    }
    #[doc = "Bit 17 - 17:17\\]
Transmission Enable for data line 1 \\[SPIDATAGZEN\\[1\\]\\]
- (RW )"]
    #[inline(always)]
    #[must_use]
    pub fn dpe1(&mut self) -> Dpe1W<Ch2confSpec> {
        Dpe1W::new(self, 17)
    }
    #[doc = "Bit 18 - 18:18\\]
Input Select - (RW )"]
    #[inline(always)]
    #[must_use]
    pub fn is(&mut self) -> IsW<Ch2confSpec> {
        IsW::new(self, 18)
    }
    #[doc = "Bit 19 - 19:19\\]
Turbo mode - (RW )"]
    #[inline(always)]
    #[must_use]
    pub fn turbo(&mut self) -> TurboW<Ch2confSpec> {
        TurboW::new(self, 19)
    }
    #[doc = "Bit 20 - 20:20\\]
Manual SPIEN assertion to keep SPIEN active between SPI words \\[single channel master mode only\\]
- (RW )"]
    #[inline(always)]
    #[must_use]
    pub fn force(&mut self) -> ForceW<Ch2confSpec> {
        ForceW::new(self, 20)
    }
    #[doc = "Bits 21:22 - 22:21\\]
read returns 0 - (RO )"]
    #[inline(always)]
    #[must_use]
    pub fn reserved_1(&mut self) -> Reserved1W<Ch2confSpec> {
...
Start bit enable for SPI transfer - (RW )"]
    #[inline(always)]
    #[must_use]
    pub fn sbe(&mut self) -> SbeW<Ch2confSpec> {
        SbeW::new(self, 23)
    }
    #[doc = "Bit 24 - 24:24\\]
Start bit polarity - (RW )"]
    #[inline(always)]
    #[must_use]
    pub fn sbpol(&mut self) -> SbpolW<Ch2confSpec> {
        SbpolW::new(self, 24)
    }
    #[doc = "Bits 25:26 - 26:25\\]
Chip Select Time Control This 2-bits field defines the number of interface clock cycles between CS toggling and first or last edge of SPI clock - (RW )"]
    #[inline(always)]
    #[must_use]
    pub fn tcs2(&mut self) -> Tcs2W<Ch2confSpec> {
        Tcs2W::new(self, 25)
    }
    #[doc = "Bit 27 - 27:27\\]
FIFO enabled for Transmit:Only one channel can have this bit field set - (RW )"]
    #[inline(always)]
    #[must_use]
    pub fn ffew(&mut self) -> FfewW<Ch2confSpec> {
        FfewW::new(self, 27)
    }
    #[doc = "Bit 28 - 28:28\\]
FIFO enabled for receive:Only one channel can have this bit field set - (RW )"]
    #[inline(always)]
    #[must_use]
    pub fn ffer(&mut self) -> FferW<Ch2confSpec> {
        FferW::new(self, 28)
    }
    #[doc = "Bit 29 - 29:29\\]
Clock divider granularity This register defines the granularity of channel clock divider: power of two or one clock cycle granularity When this bit is set the register MCSPI_CHCTRL\\[EXTCLK\\]
...
values - (RW )"]
    #[inline(always)]
    #[must_use]
    pub fn clkg(&mut self) -> ClkgW<Ch2confSpec> {
        ClkgW::new(self, 29)
    }
    #[doc = "Bits 30:31 - 31:30\\]
read returns 0 - (RO )"]
    #[inline(always)]
    #[must_use]
    pub fn reserved_0(&mut self) -> Reserved0W<Ch2confSpec> {
        Reserved0W::new(self, 30)
    }
}
#[doc = "This register is dedicated to the configuration of the channel 2\n\nYou can [`read`](crate::Reg::read) this register and get [`ch2conf::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ch2conf::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ch2confSpec;
impl crate::RegisterSpec for Ch2confSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch2conf::R`](R) reader structure"]
impl crate::Readable for Ch2confSpec {}
#[doc = "`write(|w| ..)` method takes [`ch2conf::W`](W) writer structure"]
impl crate::Writable for Ch2confSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CH2CONF to value 0"]
impl crate::Resettable for Ch2confSpec {
