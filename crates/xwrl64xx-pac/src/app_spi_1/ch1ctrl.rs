...
Channel Enable - (RW )"]
    #[inline(always)]
    #[must_use]
    pub fn en(&mut self) -> EnW<Ch1ctrlSpec> {
        EnW::new(self, 0)
    }
    #[doc = "Bits 1:7 - 7:1\\]
Read returns 0 - (RO )"]
    #[inline(always)]
    #[must_use]
    pub fn reserved_1(&mut self) -> Reserved1W<Ch1ctrlSpec> {
...
Then the max value reached is 4096 clock divider ratio - (RW )"]
    #[inline(always)]
    #[must_use]
    pub fn extclk(&mut self) -> ExtclkW<Ch1ctrlSpec> {
        ExtclkW::new(self, 8)
    }
    #[doc = "Bits 16:31 - 31:16\\]
Read returns 0 - (RO )"]
    #[inline(always)]
    #[must_use]
    pub fn reserved_2(&mut self) -> Reserved2W<Ch1ctrlSpec> {
