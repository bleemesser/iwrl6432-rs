#[doc = "Register `CH2CTRL` reader"]
pub type R = crate::R<Ch2ctrlSpec>;
#[doc = "Register `CH2CTRL` writer"]
...
Channel Enable - (RW )"]
    #[inline(always)]
    #[must_use]
    pub fn en(&mut self) -> EnW<Ch2ctrlSpec> {
        EnW::new(self, 0)
    }
    #[doc = "Bits 1:7 - 7:1\\]
Read returns 0 - (RO )"]
    #[inline(always)]
    #[must_use]
    pub fn reserved_1(&mut self) -> Reserved1W<Ch2ctrlSpec> {
...
Then the max value reached is 4096 clock divider ratio - (RW )"]
    #[inline(always)]
    #[must_use]
    pub fn extclk(&mut self) -> ExtclkW<Ch2ctrlSpec> {
        ExtclkW::new(self, 8)
    }
    #[doc = "Bits 16:31 - 31:16\\]
Read returns 0 - (RO )"]
    #[inline(always)]
    #[must_use]
    pub fn reserved_2(&mut self) -> Reserved2W<Ch2ctrlSpec> {
        Reserved2W::new(self, 16)
    }
}
#[doc = "This register is dedicated to enable the channel 2\n\nYou can [`read`](crate::Reg::read) this register and get [`ch2ctrl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ch2ctrl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ch2ctrlSpec;
impl crate::RegisterSpec for Ch2ctrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch2ctrl::R`](R) reader structure"]
impl crate::Readable for Ch2ctrlSpec {}
#[doc = "`write(|w| ..)` method takes [`ch2ctrl::W`](W) writer structure"]
impl crate::Writable for Ch2ctrlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CH2CTRL to value 0"]
