#[doc = "Register `QSECR` reader"]
pub type R = crate::R<QsecrSpec>;
#[doc = "Register `QSECR` writer"]
pub type W = crate::W<QsecrSpec>;
...
#[doc = "Field `RES75` reader - 31:8\\]
RESERVE FIELD"]
pub type Res75R = crate::FieldReader<u32>;
#[doc = "Field `RES75` writer - 31:8\\]
RESERVE FIELD"]
pub type Res75W<'a, REG> = crate::FieldWriter<'a, REG, 24, u32>;
impl R {
    #[doc = "Bit 0 - 0:0\\]
Event #0"]
    #[inline(always)]
...
RESERVE FIELD"]
    #[inline(always)]
    pub fn res75(&self) -> Res75R {
        Res75R::new((self.bits >> 8) & 0x00ff_ffff)
    }
}
impl W {
    #[doc = "Bit 0 - 0:0\\]
Event #0"]
    #[inline(always)]
    #[must_use]
    pub fn e0(&mut self) -> E0W<QsecrSpec> {
        E0W::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
Event #1"]
    #[inline(always)]
    #[must_use]
    pub fn e1(&mut self) -> E1W<QsecrSpec> {
        E1W::new(self, 1)
    }
    #[doc = "Bit 2 - 2:2\\]
Event #2"]
    #[inline(always)]
    #[must_use]
    pub fn e2(&mut self) -> E2W<QsecrSpec> {
        E2W::new(self, 2)
    }
    #[doc = "Bit 3 - 3:3\\]
Event #3"]
    #[inline(always)]
    #[must_use]
    pub fn e3(&mut self) -> E3W<QsecrSpec> {
        E3W::new(self, 3)
    }
    #[doc = "Bit 4 - 4:4\\]
Event #4"]
    #[inline(always)]
    #[must_use]
    pub fn e4(&mut self) -> E4W<QsecrSpec> {
        E4W::new(self, 4)
    }
    #[doc = "Bit 5 - 5:5\\]
Event #5"]
    #[inline(always)]
    #[must_use]
    pub fn e5(&mut self) -> E5W<QsecrSpec> {
        E5W::new(self, 5)
    }
    #[doc = "Bit 6 - 6:6\\]
Event #6"]
    #[inline(always)]
    #[must_use]
    pub fn e6(&mut self) -> E6W<QsecrSpec> {
        E6W::new(self, 6)
    }
    #[doc = "Bit 7 - 7:7\\]
Event #7"]
    #[inline(always)]
    #[must_use]
    pub fn e7(&mut self) -> E7W<QsecrSpec> {
        E7W::new(self, 7)
    }
    #[doc = "Bits 8:31 - 31:8\\]
RESERVE FIELD"]
    #[inline(always)]
    #[must_use]
    pub fn res75(&mut self) -> Res75W<QsecrSpec> {
        Res75W::new(self, 8)
    }
}
#[doc = "QDMA Secondary Event Clear Register: The secondary event clear register is used to clear the status of the QSER and QER register (note that this is slightly different than the SER operation which does not clear the ER.En register). CPU write of '1' to the QSECR.En bit clears the QSER.En and QER.En register fields. CPU write of '0' has no effect..\n\nYou can [`read`](crate::Reg::read) this register and get [`qsecr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`qsecr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct QsecrSpec;
impl crate::RegisterSpec for QsecrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`qsecr::R`](R) reader structure"]
impl crate::Readable for QsecrSpec {}
#[doc = "`write(|w| ..)` method takes [`qsecr::W`](W) writer structure"]
impl crate::Writable for QsecrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets QSECR to value 0"]
impl crate::Resettable for QsecrSpec {
